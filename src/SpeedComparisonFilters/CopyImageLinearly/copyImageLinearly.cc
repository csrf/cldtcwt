...
using namespace CopyImageLinearlyNS;

CopyImageLinearly::CopyImageLinearly(cl::Context& context, 
   ...
   workgroupSize_(workgroupSize)
{
    ...
    kernel_ = cl::Kernel(program, "copyImageLinearly");

}



void CopyImageLinearly::operator() (cl::CommandQueue& cq, 
