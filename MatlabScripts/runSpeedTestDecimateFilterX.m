function [dt] = runSpeedTestDecimateFilterX(dims, filterLength, pad)
% [dt] = runSpeedTestDecimateFilterX(dims, filterLength, pad)
% 
...
% Runs each kernel 10,000 times.
    ...
    [~, t] = system(['clDTCWT-SpeedTest-DecimateFilterX ' ...
