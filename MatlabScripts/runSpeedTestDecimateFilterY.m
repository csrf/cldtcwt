function [dt] = runSpeedTestDecimateFilterY(dims, filterLength, pad)
% [dt] = runSpeedTestDecimateFilterY(dims, filterLength, pad)
% 
% Runs clDTCWT-SpeedTest-DecimateFilterY, and returns the results (in ms) as
...
% Runs each kernel 10,000 times.
    ...
    [~, t] = system(['clDTCWT-SpeedTest-DecimateFilterY ' ...
