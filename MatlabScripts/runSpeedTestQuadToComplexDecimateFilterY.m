...
% [dt] = runSpeedTestQuadToComplexDecimateFilterY(dims, filterLength, pad)
% 
% Runs clDTCWT-SpeedTest-QuadToComplexDecimateFilterY, and returns the results (in ms) as
...
% Runs each kernel 10,000 times.
    ...
    [~, t] = system(['clDTCWT-SpeedTest-QuadToComplexDecimateFilterY ' ...
