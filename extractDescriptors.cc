...
"    const int samplerIdx = xIdx + yIdx * get_local_size(0);\n"
...
"\n"
"            // Save to matrix\n"
"            output[n + samplerIdx * numSampleLocs + idx * stride + offset]\n"
"                = result;\n"
"\n"
"        }\n"
"\n"
